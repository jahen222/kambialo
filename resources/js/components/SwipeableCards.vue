<template>
    <section class="" style="position: relative; padding: 0; height: 85vh;">
                        ...
                        <form class="row">
                            <div class="form-group col-12">
                                ...
                                <select name="category" class="custom-select js-basic-multiple" v-model="form.categories" id="categories-select2" multiple>
                                    <option v-for="x,y in categories" :value="x.id" :selected="x.id == category">
                                        {{x.name}}
                                    </option>
                                </select>
                            </div>
            ...
            <form v-on:submit.prevent="search" style="align-items: flex-end; padding: 1px;">
                <div class="col-sm-4" style="margin:10px auto;">
                    <div class="input-group col-12" style="margin:0">
                        <input placeholder="Buscar" style="border-right:0" class="form-control text-center"
                               v-model="form.search" type="text"/>
        ...
        <div class="container">
            <div class="alert-success text-center" style="opacity: 0; transition: 1s; font-size: 14pt; margin-bottom: 10px;" id="xtra-message">

            </div>
            <div class="alert-info text-center" style="opacity: 0; transition: 1s; font-size: 14pt; margin-bottom: 10px;" id="xtra-message-info">
            ...
            <div style="padding: 0 30px;">
                <div style="height:60vh; position:relative; margin: auto; margin-bottom: -5vh;" class="col-12 col-sm-4">
                    ...
                    <Vue2InteractDraggable
                        ...
                        <div style="height: 77%">
                            <a @touchstart="clickDown($event)" @touchend="clickUp($event)"
                               @mousedown="clickDown($event)" @mouseup=clickUp($event)>
                    ...
                    <div
                        ...
                        style="z-index: 2">
                        <div style="height: 77%">
                            <img :src="public + 'images/' + next.cover_image"/>
                        </div>
                        <div class="text">
                            <div class="row" style="align-items: center;">
                                <div class="col-10" style="padding: 0;">
